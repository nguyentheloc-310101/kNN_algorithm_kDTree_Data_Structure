...
public:
    ...
    void nearestNeighbour(const vector<int> &target, Node *&best, int level);
    void recNearestNeighbour(Node *temp, const vector<int> &target, Node *&best, int level);

    void kNearestNeighbour(const vector<int> &target, int k, vector<Node *> &bestList);
    void recKNearestNeighbour(Node *temp, const vector<int> &target, int k, vector<Node *> &bestList, int level);
